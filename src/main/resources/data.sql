...
</code></pre></div>', '2024-03-31 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 1)),
...
</code></pre></div>', '2024-09-01 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 2)),
...
</code></pre></div>', '2024-07-07 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 4)),
...
</code></pre></div>', '2024-06-11 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 5)),
...
</code></pre></div>', '2024-05-21 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 6)),
...
</code></pre></div>', '2024-04-11 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 7)),
...
</code></pre></div>', '2024-03-21 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 8)),
...
</code></pre></div>', '2024-05-30 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 9));
...
</code></pre></div>', '2024-07-27 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 1)),
...
</code></pre></div>', '2024-06-13 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 3)),
...
</code></pre></div>', '2024-06-15 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 5)),
...
</code></pre></div>', '2024-05-22 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 6)),
...
print(greeting)
</code></pre></div>', '2024-03-25 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 5)),
...
</code></pre></div>', '2024-06-29 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 6)),
...
</code></pre></div>', '2024-07-19 10:15:32.000000', (SELECT id FROM code_language_category LIMIT 1 OFFSET 8)),
...
이부분에서 다형성을 고려해야 할 거 같습니다.', '2024-06-29 10:15:32.000000', (SELECT id FROM code_review LIMIT 1 OFFSET 1),
        (SELECT id FROM member LIMIT 1 OFFSET 2)),
...
</code></pre></div>이 부분은 왜 이렇게 쓰신걸까요?', '2024-07-31 10:15:32.000000', (SELECT id FROM code_review LIMIT 1 OFFSET 2),
        (SELECT id FROM member LIMIT 1 OFFSET 20)),
       (UUID(), '<div data-language="text" class="toastui-editor-ww-code-block"><pre><code>
...
</code></pre></div>반복문이 너무 깊습니다.', '2024-06-20 10:15:32.000000', (SELECT id FROM code_review LIMIT 1 OFFSET 3),
        (SELECT id FROM member LIMIT 1 OFFSET 20)),
       (UUID(), '<div data-language="text" class="toastui-editor-ww-code-block"><pre><code>
...
</code></pre></div>이런 방법으로 하면 좋을 거 같습니다.', '2024-05-20 10:15:32.000000', (SELECT id FROM code_review LIMIT 1 OFFSET 4),
        (SELECT id FROM member LIMIT 1 OFFSET 22)),
       (UUID(), '<div data-language="text" class="toastui-editor-ww-code-block"><pre><code>
...
</code></pre></div>이건 어떨까요?', '2024-05-20 10:15:32.000000', (SELECT id FROM code_review LIMIT 1 OFFSET 5),
        (SELECT id FROM member LIMIT 1 OFFSET 23)),
    ...
    }요거는 어떨까요', '2024-03-20 10:15:32.000000', (SELECT id FROM code_review LIMIT 1 OFFSET 6),
        (SELECT id FROM member LIMIT 1 OFFSET 2)),
    ...
    }너무 힘들어요..', '2024-08-31 10:15:32.000000', (SELECT id FROM code_review LIMIT 1 OFFSET 7),
        (SELECT id FROM member LIMIT 1 OFFSET 29)),
    ...
    }덕분에 트리 노드를 구경했습니다.', '2024-07-31 10:15:32.000000', (SELECT id FROM code_review LIMIT 1 OFFSET 8),
        (SELECT id FROM member LIMIT 1 OFFSET 3)),
...
VALUES (UUID(), (SELECT id FROM member LIMIT 1 OFFSET 20), (SELECT id FROM code_review LIMIT 1 OFFSET 0), 1,
    '2024-08-30 10:15:32.000000'),
       ...
       (UUID(), (SELECT id FROM member LIMIT 1 OFFSET 21), (SELECT id FROM code_review LIMIT 1 OFFSET 2), 1,
        '2024-08-30 10:15:32.000000'),
       (UUID(), (SELECT id FROM member LIMIT 1 OFFSET 23), (SELECT id FROM code_review LIMIT 1 OFFSET 3), 1,
        '2024-06-29 10:15:32.000000'),
       (UUID(), (SELECT id FROM member LIMIT 1 OFFSET 24), (SELECT id FROM code_review LIMIT 1 OFFSET 4), 1,
        '2024-04-30 10:15:32.000000'),
       (UUID(), (SELECT id FROM member LIMIT 1 OFFSET 25), (SELECT id FROM code_review LIMIT 1 OFFSET 5), 1,
        '2024-04-30 10:15:32.000000'),
       (UUID(), (SELECT id FROM member LIMIT 1 OFFSET 26), (SELECT id FROM code_review LIMIT 1 OFFSET 6), 1,
        '2024-07-30 10:15:32.000000'),
       (UUID(), (SELECT id FROM member LIMIT 1 OFFSET 27), (SELECT id FROM code_review LIMIT 1 OFFSET 7), 1,
        '2024-09-30 10:15:32.000000'),
       (UUID(), (SELECT id FROM member LIMIT 1 OFFSET 28), (SELECT id FROM code_review LIMIT 1 OFFSET 8), 1,
        '2024-07-30 10:15:32.000000'),
